...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    status: Attribute.Enumeration<['pending', 'processing', 'cancelled']> &
      Attribute.Required &
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    type: Attribute.Enumeration<['normal', 'donation']> &
      Attribute.Required &
...
export interface ApiOrderMetaOrderMeta extends Schema.CollectionType {
  ...
  attributes: {
    shipping_postcode: Attribute.String & Attribute.Required;
    shipping_firstname: Attribute.String & Attribute.Required;
    order: Attribute.Relation<
      'api::order-meta.order-meta',
      'oneToOne',
      'api::order.order'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::order-meta.order-meta': ApiOrderMetaOrderMeta;
    }
  }
}
